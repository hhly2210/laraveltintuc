            ...
            <div class="container">
                <div class="float--left float--xs-none text-xs-center">
                    ...
                    <ul class="header--topbar-info nav">
                        <li>
                            <a href="{{ route('home') }}">
                                <img style="border-radius: 12px; height: 40px;"
                                    src="{{ asset('kcnew/frontend/img/image_iconLogo.png') }}" alt="logo">
                            </a>
                        </li>
                        <li><i class="fa fm fa-map-marker"></i>Nghệ An</li>
                        <li><i class="fa fm fa-mixcloud"></i>26<sup>0</sup> C</li>
                        <li style="text-transform: capitalize"><i class="fa fm fa-calendar"></i>Hôm nay (
                            {{ $now->translatedFormat('l') }}, Ngày {{ $now->translatedFormat('jS F') }} Năm
                            {{ $now->translatedFormat('Y') }} )</li>
                    </ul>
                ...
                <div class="news-updates--list" data-marquee="true">
                    <ul class="nav">
                        @foreach ($posts_new as $posts_new)
                            <li>
                                <h3 class="h3"><a
                                        href="{{ route('posts.show', $posts_new[0]) }}">{{ $posts_new[0]->title }}</a>
                                </h3>
                            </li>
                        @endforeach
                    </ul>
            ...
            <div class="row">
                ...
                <div class="col-md-2  colorlib-widget">
                    <ul class="colorlib-footer-links">
                        @for ($i = 0; $i < 4; $i++)
                            <li><a
                                    href="{{ route('categories.show', $categoryFooter[$i]) }}">{{ $categoryFooter[$i]->name }}</a>
                            </li>
                        @endfor
        ...
        <div class="container">
            <div style=" padding: 15px 0; display: flex;" class=" row">
                <div class="col-md-4">
                    <p>
                        <a href="{{ route('home') }}">
                            <img style="border-radius: 12px; width: 120px;"
                                src="{{ asset('kcnew/frontend/img/image_iconLogo.png') }}" alt="logo">
                        </a>
                    </p>
                    <p>
                ...
                <div class="col-md-4">
                    <p>
                        <span style="font-size: 14px" class="block">Tổng biên tập: 1 mình ELý</span>
                    </p>
                    <p>
                        <span style="font-size: 14px" class="block">Địa chỉ: Đại học Vinh</span>
                    </p>
                    <p>
                        <span style="font-size: 14px" class="block">Điện thoại: 0867871***</span>
                    </p>
                </div>
                <div class="col-md-4">
                    <p>
                        <small style="font-size: 14px" class="block">&copy;
                            <script type="text/javascript">
                                var date = new Date();
                                document.write(" " + date.getFullYear());
                            </script>
                            . Toàn bộ bản quyền thuộc e Lý
                        </small>
                    </p>
                    <p>
                    <ul style="display: flex;" class="header--topbar-social nav hidden-sm hidden-xxs">
                        ...
                        <li><a href="https://www.facebook.com//"><i class="fa fa-rss"></i></a></li>
                        <li><a href="https://www.facebook.com//"><i class="fa fa-youtube-play"></i></a>
                        </li>
                    </ul>
                    </p>
                </div>
    ...
    <script>
        $(function() {
            ...
            $(document).on("click", "#subscibe-btn", (e) => {
                ...
                if (!isEmail(email)) {
                    $("body").append(
                        "<div class='global-message alert alert-danger subscribe-error'>Không đúng định dạng email.</div>"
                    );
                } else {
                    //send email
                    //1 using ajax
                    ...
                    $.ajax({
                        ...
                        success: (respond) => {
                            ...
                            $("body").append(
                                "<div class='global-message alert alert-danger subscribe-success'>" +
                                message + "</div>");
                        ...
                        statusCode: {
                            500: () => {
                                $("body").append(
                                    "<div class='global-message alert alert-danger subscribe-error'>Email này đã subscribe website chúng tôi</div>"
                                );
                ...
                setTimeout(() => {
                    ...
                    $(".global-message.subscribe-error, .global-message.subscribe-success")
                        .remove();
